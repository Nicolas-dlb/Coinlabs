...
useEffect(() => {
  ...
  const CustomTooltip = ({ active, payload, number }: any) => {
...
const divise = number === 0 ? 1 : number === 1 ? 11 : number === 2 ? 100 : number === 4 ? 5000 : number === 3 ? 200 : 1;
    const price = payload[number]?.value / divise;
    if (active) {
      return (
        <>
          ...
          <div className="tooltip-bottom">
            <p>$</p>
            <p id="tooltip_price">{numberWithSpaces(getNumberFixed(price, 2))}</p>
          </div>
        </>
      );
    }
    ...
    return (
        <div  className="graph_container">
            ...
            <div className="graph">
                <ResponsiveContainer width={width ? width : !width && tooltip ? "90%" : "99%"} height={height}>
                    <AreaChart data={data}>
                        <defs>
                        ...
                        {tooltip  && (
                            <Tooltip
                                content={<CustomTooltip number={number}/>}
                        ...
                        <Area
                            ...
                            strokeWidth={selected.includes("Bitcoin") || selected.includes("All") || selected === "" ? 1 : 0}
                            type="monotone"
                            dataKey="Price"
                            stroke={
                                color === "Red"
                            ...
                            fillOpacity={1}
                            fill={ selected.includes("Bitcoin") || selected.includes("All") || selected === "" ? `url(#${color})` : "none"}
                        />
                        ...
                        <Area
                            ...
                            strokeWidth={selected.includes("Ethereum") || selected.includes("All") ? 1 : 0}
                            type="monotone"
                            dataKey="ethereum"
                            stroke="#4689b6"
                            fillOpacity={1}
                            fill={selected.includes("Ethereum") || selected.includes("All") ? `url(#Blue)` : "none"}
                        />
                        <Area
                            activeDot={{
                                stroke: "#fff",
                            ...
                            strokeWidth={selected.includes("Litecoin") || selected.includes("All") ? 1 : 0}
                            type="monotone"
                            dataKey="litecoin"
                            stroke="#db9a67"
                            fillOpacity={1}
                            fill={selected.includes("Litecoin") || selected.includes("All") ? `url(#Orange)` : "none"}
                        />
                         ...
                         <Area
                            ...
                            strokeWidth={selected.includes("Neo") || selected.includes("All") ? 1 : 0}
                            type="monotone"
                            dataKey="neo"
                            stroke="#4a9cc0"
                            fillOpacity={1}
                            fill={selected.includes("Neo") || selected.includes("All") ? `url(#Blue2)` : "none"}
                        />
                         ...
                         <Area
                            ...
                            strokeWidth={selected.includes("Ripple") || selected.includes("All") ? 1 : 0}
                            type="monotone"
                            dataKey="ripple"
                            stroke="#a075b9"
                            fillOpacity={1}
                            fill={selected.includes("Ripple") || selected.includes("All") ? `url(#Pink)` : "none"}
                        />
