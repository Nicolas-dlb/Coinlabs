...
const priceName = `${name.toLowerCase()}Price`
  ...
  const abbreviation = name === "Bitcoin" ? "BTC" : name === "Ethereum" ? "ETH" : name === "Ripple" ?  "XRP" : name === "Litecoin" ? "LTC" : name === "Neo" ? "NEO" : "BTC";
    return (
        <div className="portfolio_item">
            ...
            <div style={{ color: color }} className="portfolio_variation">
                  <svg
                ...
                <p>{numberWithSpaces(getNumberFixed(variation[name.toLowerCase()].week, 0))}</p>
                <p>%</p>
            </div>
