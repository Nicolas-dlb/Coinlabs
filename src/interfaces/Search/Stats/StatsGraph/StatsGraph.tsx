...
function Graph({
  ...
  useEffect(() => {
    if (selected.toLowerCase() === "bitcoin") {
      setNumber(0);
    } else if (selected.toLowerCase() === "ethereum") {
      setNumber(1);
    } else if (selected.toLowerCase() === "litecoin") {
      setNumber(2);
    } else if (selected.toLowerCase() === "ripple") {
      setNumber(4);
    } else if (selected.toLowerCase() === "neo") {
      setNumber(3);
    }
  }, [selected]);
        ...
        >
          <AreaChart data={data}>
            ...
            <Area
              ...
              strokeWidth={selected.toLowerCase() === "bitcoin" ? 1 : 0}
              type="monotone"
              dataKey="Price"
              stroke={
                color === "Red"
              ...
              fillOpacity={1}
              fill={
                selected.toLowerCase() === "bitcoin" ? `url(#${color})` : "none"
              }
            />
            ...
            <Area
              ...
              onMouseOver={() => {
                if (selected.toLowerCase() === "ethereum") {
                  setNumber(1);
                }
              }}
              strokeWidth={selected.toLowerCase() === "ethereum" ? 1 : 0}
              type="monotone"
              dataKey="ethereum"
              stroke="#4689b6"
              fillOpacity={1}
              fill={
                selected.toLowerCase() === "ethereum" ? `url(#Blue)` : "none"
              }
            />
            ...
            <Area
              ...
              onMouseOver={() => {
                if (selected.toLowerCase() === "litecoin") {
                  setNumber(2);
                }
              }}
              strokeWidth={selected.toLowerCase() === "litecoin" ? 1 : 0}
              type="monotone"
              dataKey="litecoin"
              stroke="#db9a67"
              fillOpacity={1}
              fill={
                selected.toLowerCase() === "litecoin" ? `url(#Orange)` : "none"
              }
            />
            ...
            <Area
              ...
              onMouseOver={() => {
                if (selected.toLowerCase() === "neo") {
                  setNumber(3);
                }
              }}
              strokeWidth={selected.toLowerCase() === "neo" ? 1 : 0}
              type="monotone"
              dataKey="neo"
              stroke="#4a9cc0"
              fillOpacity={1}
              fill={selected.toLowerCase() === "neo" ? `url(#Blue2)` : "none"}
            />
            ...
            <Area
              ...
              onMouseOver={() => {
                if (selected.toLowerCase() === "ripple") {
                  setNumber(4);
                }
              }}
              strokeWidth={selected.toLowerCase() === "ripple" ? 1 : 0}
              type="monotone"
              dataKey="ripple"
              stroke="#a075b9"
              fillOpacity={1}
              fill={selected.toLowerCase() === "ripple" ? `url(#Pink)` : "none"}
            />
          </AreaChart>
        </ResponsiveContainer>
      </div>
